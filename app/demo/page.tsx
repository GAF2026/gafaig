      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <section className="rounded-3xl border border-black/10 bg-white p-8 md:p-10">
          ...
          <p className="mt-5 max-w-3xl text-[16px] leading-8 text-black/70">
            ...
            It follows one clear sequence: private reviewer access,
            Snowflake-backed verification workflow, public certification
            registry, and global explorer surfaces.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/registry"
              className="inline-flex items-center rounded-full border border-neutral-300 px-5 py-3 text-sm font-medium transition hover:bg-neutral-50"
            >

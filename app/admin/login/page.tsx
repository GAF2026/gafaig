      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <section className="rounded-3xl border border-black/10 bg-white p-8 md:p-10">
          ...
          <p className="mt-5 max-w-3xl text-[16px] leading-8 text-black/70">
            ...
            separate from the public registry. After access is enabled,
            continue into the Snowflake-backed applications workflow.
          </p>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <section className="rounded-3xl border border-black/10 bg-white p-8">
            ...
            <div className="mt-6 rounded-2xl border border-black/10 bg-neutral-50 p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center rounded-full border border-neutral-300 px-4 py-2 text-sm font-medium transition hover:bg-neutral-100"
                >
                  Copy password
                </button>
              </div>
            ...
            <p className="mt-6 text-[14px] leading-7 text-black/60">
...
function MiniStep({
  ...
  return (
    <div className="rounded-2xl border border-black/10 p-4">
      ...
      <div className="mt-3 text-[16px] font-semibold">{title}</div>
      <p className="mt-2 text-[14px] leading-7 text-black/65">{body}</p>
    </div>
  );
}
...
function InfoCard({ text }: { text: string }) {
  return (
    <div className="rounded-2xl border border-black/10 p-4 text-[15px] leading-7 text-black/65">
      {text}
    </div>
  );
}
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        <section className="rounded-3xl border border-black/10 bg-white p-8 md:p-10">
          ...
          <h1 className="mt-3 max-w-3xl text-4xl font-semibold tracking-tight">
            The final 60-second GAFAIG walkthrough
          </h1>

          <p className="mt-5 max-w-3xl text-[16px] leading-8 text-black/70">
            This is the clean version to use with judges, investors, and
            technical evaluators. It explains the problem, shows the private
            reviewer layer, demonstrates the Snowflake-backed verification
            workflow, and finishes on the public trust layer.
          </p>
    ...
    <div className="rounded-2xl border border-black/10 p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-2 text-[20px] font-semibold">{title}</div>
        </div>
      ...
      <div className="mt-4 rounded-2xl bg-neutral-50 p-4">
        ...
        <p className="mt-2 text-[15px] leading-8 text-black/80">{say}</p>
      </div>
    </div>
  );
}

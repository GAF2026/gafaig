            ...
            {rows.map((row) => (
              ...
              >
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-3 lg:grid-cols-6">
                  ...
                  <div className="col-span-full rounded-lg border border-black/5 px-3 py-2 md:col-span-3 lg:col-span-2">
                    <div className="text-[10px] uppercase tracking-[0.18em] text-black/50">
                      Registry ID
                    </div>

                    <div className="mt-1 flex items-center justify-between gap-2">
                      <div className="break-all font-mono text-[11px] text-black/80">
                        {row.REGISTRY_ID}
                      </div>

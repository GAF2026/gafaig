...
This document defines the non-negotiable engineering rules for GAFAIG (Global Authority for AI Governance). These rules govern how the system is designed, implemented, modified, and extended across Snowflake, API, SDK, UI, widget, and public trust surfaces.
